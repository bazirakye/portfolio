...
<section id='contact' class="relative z-10 overflow-hidden bg-white dark:bg-dark py-20 lg:py-[120px]">
            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                <div class="relative p-8 bg-white rounded-lg shadow-lg dark:bg-dark-2 sm:p-12">
                    <form method="POST" action="/contact/submit"
                        ...
                        {{-- @csrf --}}
                        <div class="mb-6">
                            <x-form.input type="text" x-model="formData.name" ::class="errors.name ? 'border-red-500 focus:border-red-500' : ''"
                                placeholder="Your Name"></x-form.input>
                        ...
                        <div class="mb-6">
                            <x-form.input type="email" x-model='formData.email' ::class="errors.email ? 'border-red-500 focus:border-red-500' : ''"
                                placeholder="Your email"></x-form.input>
                            <template x-if="errors.email">
                                <div x-text="errors.email[0]" class=" text-red-500"></div>
                            </template>
                        </div>
                        <div class="mb-6">
                            <x-form.text-area rows="6" x-model='formData.body' ::class="errors.body ? 'border-red-500 focus:border-red-500' : ''"
                                placeholder="Your Message"></x-form.text-area>
